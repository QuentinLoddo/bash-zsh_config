# Generated by Powerlevel10k configuration wizard on 2022-02-27 at 19:13 CET.
...
() {
  ...
  typeset -g POwifiWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0B0'
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_FOREGROUND=72
